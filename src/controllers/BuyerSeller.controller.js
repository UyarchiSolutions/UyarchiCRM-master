...
const Delete_property_video = catchAsync(async (req, res) => {
  const data = await buyersellerService.Delete_property_video(req.params.id);
  res.send(data);
});

const post_active_inactive = catchAsync(async (req, res) => {
  const data = await buyersellerService.post_active_inactive(req.params.id, req.body);
  res.send(data);
});

const Remove_Post = catchAsync(async (req, res) => {
  const data = await buyersellerService.Remove_Post(req.params.id);
  res.send(data);
});
...
const getNotificationDetails = catchAsync(async (req, res) => {
  let userId = req.userId;
  const data = await buyersellerService.getNotificationDetails(userId);
  res.send(data);
});
...
const getIntrestedPropertyByUser_pagination = catchAsync(async (req, res) => {
  let userId = req.userId;
  const data = await buyersellerService.getIntrestedPropertyByUser_pagination(userId, req.query);
  res.send(data);
});
